...
try {
    if ($accountType === "Customer") {
        ...
        $stmt = $conn->prepare("SELECT e.EventID, e.EventName, COUNT(t.TicketID) AS TicketCount, IFNULL(SUM(t.Price), 0) AS Revenue
                                FROM event e 
        ...
        <?php else: ?>
            <?php if ($accountType === "Customer"): ?>
                ...
                <table>
                    ...
                    <tbody>
<!-- Inside the Customer account type section, update the table rows -->
...
<?php endwhile; ?>
            ...
            <?php elseif ($accountType === "Facility Owner"): ?>
                ...
                <table>
                    ...
                    <tbody>
                        <?php 
                        // Initialize total revenue if not set
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars(number_format($revenue, 2)); ?></td> <!-- Revenue Display -->
                            </tr>
                        <?php endwhile; ?>
                        <!-- Total Revenue Row -->
                        <tr>
            ...
            <?php elseif ($accountType === "Event Organizer"): ?>
                ...
                <table>
                    ...
                    <tbody>
                        <?php 
                        $totalOrganizerRevenue = 0; // Initialize total revenue for organizer
                        while ($event = $profileData->fetch_assoc()): 
                            $eventRevenue = $event['Revenue'] * 0.95; // Assuming a 2% fee similar to Facility Owner
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars(number_format($eventRevenue, 2)); ?></td> <!-- Revenue Display -->
                            </tr>
                        <?php endwhile; ?>
                        <!-- Total Revenue Row -->
                        <tr>
            ...
            <?php else: ?>
                <!-- This else block handles any unknown account types -->
