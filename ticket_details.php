...
if ($ticketID > 0) {
    // **Modified SQL Statement: Added f.City, f.Region, and f.FacilityName**
    $stmt = $conn->prepare("SELECT 
                                ...
                                f.GMLocationLink, 
                                f.City,           -- Added City
                                f.Region,         -- Added Region
                                f.FacilityName,   -- Added FacilityName
                                e.BannerImage
                            FROM 
                                ticket t 
                            JOIN 
        ...
        <div class="left">
            ...
            <div class="ticket-info">
                ...
                <div class="show-name">
                    ...
                    <h5><?php echo htmlspecialchars($ticket['Class']); ?></h5>
                </div>
                <div class="time">
                ...
                <p class="location">
                    <span>
                        <!-- **Modified: FacilityName is now the link text for Google Maps** -->
                        <a href="<?php echo htmlspecialchars($ticket['GMLocationLink']); ?>" target="_blank">
                            <?php echo htmlspecialchars($ticket['FacilityName']); ?>
                        </a>
                    </span>
                    <span>
                    <a href="<?php echo htmlspecialchars($ticket['GMLocationLink']); ?>" target="_blank">
                    <?php echo htmlspecialchars($ticket['City'] . ', ' . $ticket['Region']); ?>
                        </a>
                    </span>
                </p>
            </div>
